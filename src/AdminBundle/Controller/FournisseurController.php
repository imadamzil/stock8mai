...
use AdminBundle\Entity\Fournisseur;
...
class FournisseurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $fournisseurs = $em->getRepository('AdminBundle:Fournisseur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdminBundle\Form\FournisseurType', $fournisseur);
    ...
    {
        $deleteForm = $this->createDeleteForm($fournisseur);
        $editForm = $this->createForm('AdminBundle\Form\FournisseurType', $fournisseur);
