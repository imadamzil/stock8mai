...
use AdminBundle\Entity\Personne;
...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personnes = $em->getRepository('AdminBundle:Personne')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdminBundle\Form\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('AdminBundle\Form\PersonneType', $personne);
