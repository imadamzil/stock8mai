...
use AdminBundle\Entity\Prestataire;
...
class PrestataireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $prestataires = $em->getRepository('AdminBundle:Prestataire')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AdminBundle\Form\PrestataireType', $prestataire);
    ...
    {
        $deleteForm = $this->createDeleteForm($prestataire);
        $editForm = $this->createForm('AdminBundle\Form\PrestataireType', $prestataire);
